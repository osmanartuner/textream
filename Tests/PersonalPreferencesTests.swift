...
@main
struct PersonalPreferencesTests {
    ...
    static func main() throws {
        ...
        let suiteName = "dev.osmanartuner.textream.preferences-tests.\(UUID().uuidString)"
        ...
        print("All personal preference and window geometry checks passed.")
    }
}
